...
test('Natural Armor lineage advantage adds Natural Armor', () => {
  const s = validate(makeChar('Druid 10', { lineage: 'Oaksworn', lineageAdvantages: ['Hardened Flesh (Dryad)'] })).stats;
...
test('dedupe: class starting Bookcaster skills + additional purchased Bookcaster', () => {
  const c = makeChar('Mage 4', { startingKit: false, add: [ // starts with Bookcaster, Bookcaster
