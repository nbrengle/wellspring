...
export { computeSlots, spellSlots, bookcasterSpellOptions, arcaneSecretsSpellOptions, weirdWanderingsOptions, eligibleClassChoices, agileLearnerCapacity, basicSpellOptions } from './validate/slots.js';
