  ...
  return (
    <ul className="b-rows">
      {rows.map((row) => {
        ...
        const canBuyUp = fromClass && grantedFloor > 0 && maxR > grantedFloor && !UNLIMITED_SKILLS.has(baseName);
                    ...
                    <>
                      {src && (
                        <span
                          ...
                          title={
                            specialty
                              ? `Granted free by your ${src}'s "${specialty}" starting choice`
                              : grantedBy
                                ? `Granted free by your ${grantedBy} multi-class`
                      ...
                      {refundedBP ? (
                        <span
                          ...
                          title="BP spent on this item was refunded because your class grants it for free"
                        >
