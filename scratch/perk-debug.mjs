...
const mildAllergyIndex = nodes.findIndex((n) => n.type === 'heading' && n.level === 4 && n.text === 'Mild Allergy');
const severeAllergyIndex = nodes.findIndex((n) => n.type === 'heading' && n.level === 4 && n.text === 'Severe Allergy');

console.log('Nodes for Mild Allergy:');
for (let i = mildAllergyIndex; i < severeAllergyIndex; i++) {
